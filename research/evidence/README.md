...
| --- | --- | --- |
| [`VC-HEAD-20230430`](../execution/week-01/results/step-02-baselines.json#L5) | 上游 commit [`03e1f2df49bb9664c8bdae11cf911f56b74bbc57`](../execution/week-01/results/step-02-baselines.json#L17) | 原始源码基线 |
| [`VC-REF-95`](../execution/week-01/results/step-02-baselines.json#L6) | 原始基线 + [`pr-95-fix-locktable.patch`](patches/pr-95-fix-locktable.patch) | 经审查的参考修复，不宣称官方版本 |
| [`VC-INST-*`](../plan.md#L128) | [`VC-REF-95`](../execution/week-01/results/step-02-baselines.json#L6) + 最小事件插桩 | 主实验 SUT |
| [`VC-MUT-*`](../plan.md#L129) | 单个 [`VC-INST-*`](../plan.md#L128) + 单 mutation | 检出率与诊断实验 |

保留补丁的 SHA-256 为 [`E3C79288D13A8C8706227879DC38DB93562DAE92C4E1CBB82B0E10B8FACAD145`](../execution/week-01/results/step-02-baselines.json#L25)；[`.gitattributes`](../../.gitattributes) 禁止 Git 改写其行尾。
...
- [`LockTable.java`](../../src/main/java/org/vanilladb/core/storage/tx/concurrency/LockTable.java) 的 [`lockerMap`](../../src/main/java/org/vanilladb/core/storage/tx/concurrency/LockTable.java#L102) 由不同资源 anchor 上的 monitor 访问，PR #95 将其改为并发 map；需构造跨 anchor 并发见证。
- 同一补丁在 unlock 路径清理 [`txWaitMap`](../../src/main/java/org/vanilladb/core/storage/tx/concurrency/LockTable.java#L105)；需区分内存/状态泄漏、错误 abort 标记和可观察事务失败。
...
3. 补丁应用前执行 [`git apply --check`](https://git-scm.com/docs/git-apply)，并记录 SHA-256。
